...
go mod init clients
GOBIN=$(go env GOPATH)/bin go get github.com/unistack-org/protoc-gen-all github.com/golang/protobuf/protoc-gen-go@v1.3.5 github.com/micro/protoc-gen-micro/v2 github.com/micro/go-micro/v2@master

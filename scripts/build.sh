...
sudo apt install -y --no-install-recommends python3 python3-pip python3-setuptools python3-dev
# debian stuff python3-grpcio python-protobuf python3-grpc-tools

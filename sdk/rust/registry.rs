...
impl Service {
    ...
    pub fn get_options(&self) -> &Options {
        self.options.as_ref().unwrap_or_else(|| Options::default_instance())
    }
...
impl Endpoint {
    ...
    pub fn get_request(&self) -> &Value {
        self.request.as_ref().unwrap_or_else(|| Value::default_instance())
    }
    ...
    pub fn get_response(&self) -> &Value {
        self.response.as_ref().unwrap_or_else(|| Value::default_instance())
    }
...
impl ::protobuf::Message for Options {
    ...
    fn default_instance() -> &'static Options {
        static mut instance: ::protobuf::lazy::Lazy<Options> = ::protobuf::lazy::Lazy::INIT;
        unsafe {
...
impl ::protobuf::Message for EmptyResponse {
    ...
    fn default_instance() -> &'static EmptyResponse {
        static mut instance: ::protobuf::lazy::Lazy<EmptyResponse> = ::protobuf::lazy::Lazy::INIT;
        unsafe {

...
impl SubscribeRequest {
    ...
    pub fn get_start_at_time(&self) -> i64 {
        self.start_at_time
    }
    pub fn clear_start_at_time(&mut self) {
        self.start_at_time = 0;
    }

    // Param is passed by value, moved
    pub fn set_start_at_time(&mut self, v: i64) {
        self.start_at_time = v;
    }
...
impl ::protobuf::Message for SubscribeRequest {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.queue.is_empty() {
            my_size += ::protobuf::rt::string_size(1, &self.queue);
        }
        if !self.topic.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.topic);
        }
        if self.start_at_time != 0 {
            my_size += ::protobuf::rt::value_size(3, self.start_at_time, ::protobuf::wire_format::WireTypeVarint);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        if !self.queue.is_empty() {
            os.write_string(1, &self.queue)?;
        }
        if !self.topic.is_empty() {
            os.write_string(2, &self.topic)?;
        }
        if self.start_at_time != 0 {
            os.write_int64(3, self.start_at_time)?;
        }
        if self.auto_ack != false {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                "start_at_time",
                |m: &SubscribeRequest| { &m.start_at_time },
                |m: &mut SubscribeRequest| { &mut m.start_at_time },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "auto_ack",
                |m: &SubscribeRequest| { &m.auto_ack },
                |m: &mut SubscribeRequest| { &mut m.auto_ack },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                "ack_wait",
                |m: &SubscribeRequest| { &m.ack_wait },
                |m: &mut SubscribeRequest| { &mut m.ack_wait },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt64>(
                "retry_limit",
                |m: &SubscribeRequest| { &m.retry_limit },
                |m: &mut SubscribeRequest| { &mut m.retry_limit },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    lue:\x028\x01\"\x11\n\x0fPublishResponse\"\xb9\x01\n\x10SubscribeRequest\
    \x12\x14\n\x05queue\x18\x01\x20\x01(\tR\x05queue\x12\x14\n\x05topic\x18\
    \x02\x20\x01(\tR\x05topic\x12\"\n\rstart_at_time\x18\x03\x20\x01(\x03R\
    \x0bstartAtTime\x12\x19\n\x08auto_ack\x18\x04\x20\x01(\x08R\x07autoAck\
    \x12\x19\n\x08ack_wait\x18\x05\x20\x01(\x03R\x07ackWait\x12\x1f\n\x0bret\
    ry_limit\x18\x06\x20\x01(\x03R\nretryLimit\"\xdb\x01\n\x05Event\x12\x0e\
    \n\x02id\x18\x01\x20\x01(\tR\x02id\x12\x14\n\x05topic\x18\x02\x20\x01(\t\
    R\x05topic\x127\n\x08metadata\x18\x03\x20\x03(\x0b2\x1b.events.Event.Met\
    adataEntryR\x08metadata\x12\x18\n\x07payload\x18\x04\x20\x01(\x0cR\x07pa\
    yload\x12\x1c\n\ttimestamp\x18\x05\x20\x01(\x03R\ttimestamp\x1a;\n\rMeta\
    dataEntry\x12\x10\n\x03key\x18\x01\x20\x01(\tR\x03key\x12\x14\n\x05value\
    \x18\x02\x20\x01(\tR\x05value:\x028\x01\"Q\n\x0bReadRequest\x12\x14\n\
    \x05topic\x18\x01\x20\x01(\tR\x05topic\x12\x14\n\x05limit\x18\x02\x20\
    \x01(\x04R\x05limit\x12\x16\n\x06offset\x18\x03\x20\x01(\x04R\x06offset\
    \"5\n\x0cReadResponse\x12%\n\x06events\x18\x01\x20\x03(\x0b2\r.events.Ev\
    entR\x06events\"E\n\x0cWriteRequest\x12#\n\x05event\x18\x01\x20\x01(\x0b\
    2\r.events.EventR\x05event\x12\x10\n\x03ttl\x18\x02\x20\x01(\x03R\x03ttl\
    \"\x0f\n\rWriteResponse\"6\n\nAckRequest\x12\x0e\n\x02id\x18\x01\x20\x01\
    (\tR\x02id\x12\x18\n\x07success\x18\x02\x20\x01(\x08R\x07success2|\n\x06\
    Stream\x12:\n\x07Publish\x12\x16.events.PublishRequest\x1a\x17.events.Pu\
    blishResponse\x126\n\tSubscribe\x12\x18.events.SubscribeRequest\x1a\r.ev\
    ents.Event0\x012p\n\x05Store\x121\n\x04Read\x12\x13.events.ReadRequest\
    \x1a\x14.events.ReadResponse\x124\n\x05Write\x12\x14.events.WriteRequest\
    \x1a\x15.events.WriteResponseB.Z,github.com/micro/micro/v3/proto/event;e\
    ...
    \x13\n\x0b\n\x04\x04\0\x02\x03\x12\x03\x13\x02\x16\n\r\n\x05\x04\0\x02\
    \x03\x04\x12\x04\x13\x02\x12\x14\n\x0c\n\x05\x04\0\x02\x03\x05\x12\x
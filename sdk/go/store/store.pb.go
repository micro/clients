...
var file_store_store_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x06, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x73, 0x32, 0xd9, 0x02, 0x0a, 0x05, 0x53,
	...
	0x2f, 0x76, 0x33, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x3b,
...
var file_store_store_proto_goTypes = []interface{}{
	...
	nil,                       // 18: store.Record.MetadataEntry
}
var file_store_store_proto_depIdxs = []int32{
	18, // 0: store.Record.metadata:type_name -> store.Record.MetadataEntry
	...
	0,  // 7: store.Record.MetadataEntry.value:type_name -> store.Field
	3,  // 8: store.Store.Read:input_type -> store.ReadRequest
	6,  // 9: store.Store.Write:input_type -> store.WriteRequest
	9,  // 10: store.Store.Delete:input_type -> store.DeleteRequest
	12, // 11: store.Store.List:input_type -> store.ListRequest
	14, // 12: store.Store.Databases:input_type -> store.DatabasesRequest
	16, // 13: store.Store.Tables:input_type -> store.TablesRequest
	4,  // 14: store.Store.Read:output_type -> store.ReadResponse
	7,  // 15: store.Store.Write:output_type -> store.WriteResponse
	10, // 16: store.Store.Delete:output_type -> store.DeleteResponse
	13, // 17: store.Store.List:output_type -> store.ListResponse
	15, // 18: store.Store.Databases:output_type -> store.DatabasesResponse
	17, // 19: store.Store.Tables:output_type -> store.TablesResponse

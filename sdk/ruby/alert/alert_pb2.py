...
ReportEventRequest = _reflection.GeneratedProtocolMessageType('ReportEventRequest', (_message.Message,), dict(
...
ReportEventResponse = _reflection.GeneratedProtocolMessageType('ReportEventResponse', (_message.Message,), dict(

...
_SUBSCRIBEREQUEST = _descriptor.Descriptor(
  ...
  full_name='events.SubscribeRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='queue', full_name='events.SubscribeRequest.queue', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='topic', full_name='events.SubscribeRequest.topic', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='start_at_time', full_name='events.SubscribeRequest.start_at_time', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='auto_ack', full_name='events.SubscribeRequest.auto_ack', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ack_wait', full_name='events.SubscribeRequest.ack_wait', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='retry_limit', full_name='events.SubscribeRequest.retry_limit', index=5,
...
_STREAM = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='Subscribe',
    full_name='events.Stream.Subscribe',
    index=1,
    containing_service=None,

...
public final class BrokerGrpc {
  ...
  public static final String SERVICE_NAME = "go.micro.broker.Broker";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<go.micro.broker.BrokerOuterClass.PublishRequest,
      go.micro.broker.BrokerOuterClass.Empty> getPublishMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Publish",
      requestType = go.micro.broker.BrokerOuterClass.PublishRequest.class,
      responseType = go.micro.broker.BrokerOuterClass.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<go.micro.broker.BrokerOuterClass.PublishRequest,
      go.micro.broker.BrokerOuterClass.Empty> getPublishMethod() {
    io.grpc.MethodDescriptor<go.micro.broker.BrokerOuterClass.PublishRequest, go.micro.broker.BrokerOuterClass.Empty> getPublishMethod;
      ...
      synchronized (BrokerGrpc.class) {
        if ((getPublishMethod = BrokerGrpc.getPublishMethod) == null) {
          BrokerGrpc.getPublishMethod = getPublishMethod =
              io.grpc.MethodDescriptor.<go.micro.broker.BrokerOuterClass.PublishRequest, go.micro.broker.BrokerOuterClass.Empty>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Publish"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  go.micro.broker.BrokerOuterClass.PublishRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  go.micro.broker.BrokerOuterClass.Empty.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<go.micro.broker.BrokerOuterClass.SubscribeRequest,
      go.micro.broker.BrokerOuterClass.Message> getSubscribeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Subscribe",
      requestType = go.micro.broker.BrokerOuterClass.SubscribeRequest.class,
      responseType = go.micro.broker.BrokerOuterClass.Message.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<go.micro.broker.BrokerOuterClass.SubscribeRequest,
      go.micro.broker.BrokerOuterClass.Message> getSubscribeMethod() {
    io.grpc.MethodDescriptor<go.micro.broker.BrokerOuterClass.SubscribeRequest, go.micro.broker.BrokerOuterClass.Message> getSubscribeMethod;
    if ((getSubscribeMethod = BrokerGrpc.getSubscribeMethod) == null) {
      synchronized (BrokerGrpc.class) {
        if ((getSubscribeMethod = BrokerGrpc.getSubscribeMethod) == null) {
          BrokerGrpc.getSubscribeMethod = getSubscribeMethod =
              io.grpc.MethodDescriptor.<go.micro.broker.BrokerOuterClass.SubscribeRequest, go.micro.broker.BrokerOuterClass.Message>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Subscribe"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  go.micro.broker.BrokerOuterClass.SubscribeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  go.micro.broker.BrokerOuterClass.Message.getDefaultInstance()))
  ...
  public static abstract class BrokerImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void publish(go.micro.broker.BrokerOuterClass.PublishRequest request,
        io.grpc.stub.StreamObserver<go.micro.broker.BrokerOuterClass.Empty> responseObserver) {
      asyncUnimplementedUnaryCall(getPublishMethod(), responseObserver);
    }

    /**
     */
    public void subscribe(go.micro.broker.BrokerOuterClass.SubscribeRequest request,
        io.grpc.stub.StreamObserver<go.micro.broker.BrokerOuterClass.Message> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                go.micro.broker.BrokerOuterClass.PublishRequest,
                go.micro.broker.BrokerOuterClass.Empty>(
                  this, METHODID_PUBLISH)))
          .addMethod(
            getSubscribeMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                go.micro.broker.BrokerOuterClass.SubscribeRequest,
                go.micro.broker.BrokerOuterClass.Message>(
  ...
  public static final class BrokerBlockingStub extends io.grpc.stub.AbstractBlockingStub<BrokerBlockingStub> {
    ...
    /**
     */
    public go.micro.broker.BrokerOuterClass.Empty publish(go.micro.broker.BrokerOuterClass.PublishRequest request) {
    ...
    /**
     */
    public java.util.Iterator<go.micro.broker.BrokerOuterClass.Message> subscribe(
        go.micro.broker.BrokerOuterClass.SubscribeRequest request) {
  ...
  public static final class BrokerFutureStub extends io.grpc.stub.AbstractFutureStub<BrokerFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<go.micro.broker.BrokerOuterClass.Empty> publish(
        go.micro.broker.BrokerOuterClass.PublishRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PUBLISH:
          serviceImpl.publish((go.micro.broker.BrokerOuterClass.PublishRequest) request,
              (io.grpc.stub.StreamObserver<go.micro.broker.BrokerOuterClass.Empty>) responseObserver);
          break;
        case METHODID_SUBSCRIBE:
          serviceImpl.subscribe((go.micro.broker.BrokerOuterClass.SubscribeRequest) request,
              (io.grpc.stub.StreamObserver<go.micro.broker.BrokerOuterClass.Message>) responseObserver);
          break;
        default:
  ...
  private static abstract class BrokerBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return go.micro.broker.BrokerOuterClass.getDescriptor();
    }
